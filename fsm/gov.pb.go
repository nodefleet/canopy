...
type ConsensusParams struct {
	...
	// gas_per_storage_read: gas cost for contract storage read operations
	GasPerStorageRead uint64 `protobuf:"varint,5,opt,name=gas_per_storage_read,json=gasPerStorageRead,proto3" json:"gasPerStorageRead"` // @gotags: json:"gasPerStorageRead"
	// gas_per_storage_write: gas cost for contract storage write operations
	GasPerStorageWrite uint64 `protobuf:"varint,6,opt,name=gas_per_storage_write,json=gasPerStorageWrite,proto3" json:"gasPerStorageWrite"` // @gotags: json:"gasPerStorageWrite"
	// gas_per_storage_delete: gas cost for contract storage delete operations
	GasPerStorageDelete uint64 `protobuf:"varint,7,opt,name=gas_per_storage_delete,json=gasPerStorageDelete,proto3" json:"gasPerStorageDelete"` // @gotags: json:"gasPerStorageDelete"
	// max_gas_per_transaction: maximum gas allowed per transaction
	MaxGasPerTransaction uint64 `protobuf:"varint,8,opt,name=max_gas_per_transaction,json=maxGasPerTransaction,proto3" json:"maxGasPerTransaction"` // @gotags: json:"maxGasPerTransaction"
}
...
func (x *ConsensusParams) GetGasPerStorageRead() uint64 {
	if x != nil {
		return x.GasPerStorageRead
	}
	return 0
}

func (x *ConsensusParams) GetGasPerStorageWrite() uint64 {
	if x != nil {
		return x.GasPerStorageWrite
	}
	return 0
}

func (x *ConsensusParams) GetGasPerStorageDelete() uint64 {
	if x != nil {
		return x.GasPerStorageDelete
	}
	return 0
}

func (x *ConsensusParams) GetMaxGasPerTransaction() uint64 {
	if x != nil {
		return x.MaxGasPerTransaction
	}
	return 0
}
...
type FeeParams struct {
	...
	// store_code_fee: is the fee amount (in uCNPY) for Message Store Code
	StoreCodeFee uint64 `protobuf:"varint,14,opt,name=store_code_fee,json=storeCodeFee,proto3" json:"storeCodeFee"` // @gotags: json:"storeCodeFee"
	// instantiate_contract_fee: is the fee amount (in uCNPY) for Message Instantiate Contract
	InstantiateContractFee uint64 `protobuf:"varint,15,opt,name=instantiate_contract_fee,json=instantiateContractFee,proto3" json:"instantiateContractFee"` // @gotags: json:"instantiateContractFee"
	// execute_contract_fee: is the fee amount (in uCNPY) for Message Execute Contract
	ExecuteContractFee uint64 `protobuf:"varint,16,opt,name=execute_contract_fee,json=executeContractFee,proto3" json:"executeContractFee"` // @gotags: json:"executeContractFee"
	// migrate_contract_fee: is the fee amount (in uCNPY) for Message Migrate Contract
	MigrateContractFee uint64 `protobuf:"varint,17,opt,name=migrate_contract_fee,json=migrateContractFee,proto3" json:"migrateContractFee"` // @gotags: json:"migrateContractFee"
	// update_admin_fee: is the fee amount (in uCNPY) for Message Update Admin
	UpdateAdminFee uint64 `protobuf:"varint,18,opt,name=update_admin_fee,json=updateAdminFee,proto3" json:"updateAdminFee"` // @gotags: json:"updateAdminFee"
	// clear_admin_fee: is the fee amount (in uCNPY) for Message Clear Admin
	ClearAdminFee uint64 `protobuf:"varint,19,opt,name=clear_admin_fee,json=clearAdminFee,proto3" json:"clearAdminFee"` // @gotags: json:"clearAdminFee"
}
...
func (x *FeeParams) GetStoreCodeFee() uint64 {
	if x != nil {
		return x.StoreCodeFee
	}
	return 0
}

func (x *FeeParams) GetInstantiateContractFee() uint64 {
	if x != nil {
		return x.InstantiateContractFee
	}
	return 0
}

func (x *FeeParams) GetExecuteContractFee() uint64 {
	if x != nil {
		return x.ExecuteContractFee
	}
	return 0
}

func (x *FeeParams) GetMigrateContractFee() uint64 {
	if x != nil {
		return x.MigrateContractFee
	}
	return 0
}

func (x *FeeParams) GetUpdateAdminFee() uint64 {
	if x != nil {
		return x.UpdateAdminFee
	}
	return 0
}

func (x *FeeParams) GetClearAdminFee() uint64 {
	if x != nil {
		return x.ClearAdminFee
	}
	return 0
}
...
var file_gov_proto_rawDesc = []byte{
	...
	0x28, 0x04, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xe9, 0x02, 0x0a, 0x0f,
	...
	,
	...
	0x69, 0x65, 0x72, 0x22, 0x8d, 0x06, 0x0a, 0x09, 0x46, 0x65, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d,
	...
	,
	...
	0x6f, 0x72, 0x6b, 0x2f, 0x63, 0x61, 0x6e, 0x6f, 0x70, 0x79, 0x2f, 0x66, 0x73, 0x6d, 0x62, 0x06,
